...
export class NounsDAOLogicV2 extends ethereum.SmartContract {
  static bind(address: Address): NounsDAOLogicV2 {
    return new NounsDAOLogicV2("NounsDAOLogicV2", address);
  }
